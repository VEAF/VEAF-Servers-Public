...
SRSAuto.SERVER_SRS_PORT = "10405" --  SRS Server default is 5002 TCP & UDP
SRSAuto.SERVER_SRS_HOST = "srs.mydomain.org" -- overridden if SRS_HOST_AUTO is true -- set to your PUBLIC ipv4 address
...
SRSAuto.SRS_NUDGE_PATH = "C:\\Users\\veaf\\Saved Games\\private_server\\DCS-SimpleRadio-Standalone\\clients-list.json" -- path to SERVER JSON EXPORT - enable Auto Export List on the server
...
SRSAuto.SRS_NUDGE_MESSAGE = "****** Merci de vous connecter à notre SRS : srs.mydomain.org  ******\\\n\\\nDe plus, nous vous demandons de respecter les procédures de démarrage, taxi et décollage sur les aéroports\\\n\\\nVous pouvez installer DCS SimpleRadio Standalone - SRS - gratuitement."
