...
--[=[If the admin tools are enabled, then this variable matters.  
    ...
    admin_tools_mission_folder = [[c:\Users\veaf\Saved Games\DCS.missions\_VEAF_OpenTraining.private]]
...
--[[If the admin tools are enabled, then this variable matters.  
    ...
    admin_register_password = "DOWNWARD1blueing!enceinte"
...
--[[Enter your custom MOTD here.  It replaces the first line of the default MOTD.]]
    custom_MOTD = "Bienvenue sur le serveur privé."
